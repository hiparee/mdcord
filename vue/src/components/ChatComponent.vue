    ...
    <div class="d-flex flex-column" style="">
      <div class="" style="background: none; border: 0">
        <div class="p-3">
          ...
          <div
            class="divider d-flex align-items-center justify-content-center mb-4"
          >
        ...
        <div
          class="chat-footer text-muted d-flex justify-content-start align-items-center p-3"
        >
          <input
            type="text"
        ...
        <div>
          <div v-for="(item, index) in chatList" :key="index">
            ...
            <div>
              ...
              <div>
                <span style="white-space: pre-line">{{ item.msg }}</span>
              </div>
            </div>
          </div>
        </div>
